...
export type OIDCModelProps = {
  name: OIDCModelName,
  logger?: Logger,
};

export abstract class OIDCModel<M extends OIDCModelPayload = OIDCModelPayload> implements OIDCModelAdapter {
  /**
   *
  ...
  constructor(protected readonly props: OIDCModelProps, options?: any) {
    if (props.logger) {
   ...
   *
   */
  public abstract async upsert(id: string, data: M, expiresIn: number): Promise<void>;
   ...
   *
   */
  public abstract async find(id: string): Promise<M | undefined>;
   ...
   *
   */
  public abstract async findByUserCode(userCode: string): Promise<M | undefined>;
   ...
   *
   */
  public abstract async findByUid(uid: string): Promise<M | undefined>;
