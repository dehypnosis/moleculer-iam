...
export declare abstract class OIDCModel<M extends OIDCModelPayload = OIDCModelPayload> implements OIDCModelAdapter {
     ...
     *
     */
    abstract get(opts?: FindOptions): Promise<M[]>;
     ...
     *
     */
    abstract upsert(id: string, data: M, expiresIn: number): Promise<void>;
    /**
     *
     ...
     *
     */
    abstract find(id: string): Promise<M | undefined>;
    /**
     *
     ...
     *
     */
    abstract findByUserCode(userCode: string): Promise<M | undefined>;
    /**
     *
     ...
     *
     */
    abstract findByUid(uid: string): Promise<M | undefined>;
    /**
     *
