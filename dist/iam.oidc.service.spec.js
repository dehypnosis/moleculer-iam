...
const iam_oidc_service_1 = require("./iam.oidc.service");
describe("Test OIDCProviderService", () => {
    const broker = new moleculer_1.ServiceBroker();
    const service = broker.createService(iam_oidc_service_1.OIDCProviderService);
...
//# sourceMappingURL=iam.oidc.service.spec.js.map