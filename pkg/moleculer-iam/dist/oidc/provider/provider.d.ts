...
export declare class OIDCProvider {
    ...
    readonly routes: import("koa-compose").Middleware<import("koa").ParameterizedContext<unknown, unknown>>;
    ...
    findClientOrFail(id: string): Promise<any>;
    ...
    getClients(args?: FindOptions): Promise<any[]>;
