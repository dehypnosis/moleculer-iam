...
exports.useRegisterInteraction = ({ idp, provider, url, router }) => {
    ...
    router.post("/register", async (ctx) => {
        ...
        // 1. extend TTL
        await interaction.save(moment_1.default().isAfter((interaction.exp / 1000) + 60 * 30, "s") ? interaction.exp + 60 * 30 : undefined);
...
//# sourceMappingURL=interaction.register.js.map