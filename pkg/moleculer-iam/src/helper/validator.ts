import Validator, { ValidationSchema, ValidationError, ValidationRule, RuleObject, MessagesType } from "fastest-validator";
...
export type ValidationErrorMessages = typeof messages;

export const validator = new Validator({
  messages,
});

export function createValidationError(args: { type: keyof typeof messages, field: string, expected?: any, actual?: any  }): ValidationError {
